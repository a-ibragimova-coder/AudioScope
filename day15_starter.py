...
BANDS = [
    ...
    ("High-mid", 2100, 4200,  "#00acc1"),   # Cyan — presence, clarity
    ("Treble",   4200, 12500, "#1e88e5"),   # Blue — brightness, cymbals
    ("Air",      12500, 21000, "#8e24aa"),  # Purple — shimmer
]
...
# Ignore very low frequencies (< 100 Hz) — they're mostly noise.
#
def find_peak_frequency(fft_magnitudes, freq_array, min_freq=100):
